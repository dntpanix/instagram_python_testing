...
class BaseElementActions(ABC):
    ...
    @abstractmethod
    def click(self, x_offset: int = 0, y_offset: int = 0, hold_seconds: float = 0): pass
    
    @abstractmethod
    def right_click(self, x_offset: int = 0, y_offset: int = 0): pass
    
    @abstractmethod
    def send_keys(self, text: str, clear_first: bool = True): pass
    
    @abstractmethod
    def get_text(self) -> str: pass
    
    @abstractmethod
    def get_attribute(self, attr_name: str) -> Optional[str]: pass
    
    @abstractmethod
    def select_by_text(self, text: str): pass
