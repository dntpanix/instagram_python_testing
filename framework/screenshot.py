...
class BaseScreenshotManager(ABC):
    ...
    @abstractmethod
    def highlight_and_screenshot(self, element, file_name: str = 'element.png'): pass
    
    @abstractmethod
    def highlight_and_screenshot_many(self, elements: List, file_name: str = 'elements.png'): pass
...
class SeleniumScreenshotManager(BaseScreenshotManager):
    ...
    def highlight_and_screenshot_many(self, elements: List, file_name: str = 'elements.png'):
...
class PlaywrightScreenshotManager(BaseScreenshotManager):
    ...
    def highlight_and_screenshot(self, locator, file_name: str = 'element.png'):
        ...
        self.page.evaluate(
            "elem => elem.style.border='3px solid red'",
            locator.element_handle()
        )
        self.page.screenshot(path=file_name)
    
    def highlight_and_screenshot_many(self, locators: List, file_name: str = 'elements.png'):
        """Highlight multiple elements and take screenshot"""
